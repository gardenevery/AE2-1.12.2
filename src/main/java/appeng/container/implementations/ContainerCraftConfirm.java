    ...
    public void startJob() {
        ...
        if (this.result != null && !this.isSimulation()) {
            ...
            if (g == null) {
                ...
                if (te != null) {
                    Platform.openGUI(this.getInventoryPlayer().player, te, this.getOpenContext().getSide(),
                            originalGui);
                } else {
                    if (ah instanceof IInventorySlotAware i) {
                        Platform.openGUI(this.getInventoryPlayer().player, i.getInventorySlot(), originalGui,
                                i.isBaubleSlot());
                    }
                }
            }
